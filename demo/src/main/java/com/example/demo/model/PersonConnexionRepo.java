...
public interface PersonConnexionRepo extends  JpaRepository<PersonConnection, Long>{

    public PersonConnection findByUsername(String username); // cette donction à implémenter sert à retrouver l'utilisateur par son username dans UserService (avec  l'implementation de l'interface UserDetailsService)
